...
Namespace ws_iCDataManager
    ...
    Public Class iCDataObject
        ...
        Public Sub New()
            MyBase.New
            Dim urlSetting As String = System.Configuration.ConfigurationSettings.AppSettings("iCDataManager2Tester.ws_iCDataManager.iCDataObject")
            If (Not (urlSetting) Is Nothing) Then
                Me.Url = String.Concat(urlSetting, "")
            Else
                Me.Url = "http://localhost/Development/iConsulting/iCMComponents/wwwroot/iCDataManager2/iCD"& _ 
"ataObject.asmx"
            End If
        End Sub
