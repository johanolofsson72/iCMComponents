Module Constants
    ...
    Public Const ERR_GETMULTIDATASET = ERR_BASE_NUMBER + 33
    Public Const ERR_GETDATASCALAR = ERR_BASE_NUMBER + 34
    Public Const ERR_GETDEFINEDDATASET = ERR_BASE_NUMBER + 35
    Public Const ERR_SAVEBLOBDATA = ERR_BASE_NUMBER + 36
