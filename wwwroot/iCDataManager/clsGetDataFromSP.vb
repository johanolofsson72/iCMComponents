...
Namespace iConsulting.iCMServer
    ...
    Public NotInheritable Class clsGetDataFromSP : Inherits iConsulting.iCMServer.clsConnection

        Const CLASSNAME = "[Namespace::iConsulting.iCMServer][WebService::iCDataManager][Class::clsGetDataFromSP]"
...
#Region " Public Functions "
        ...
        Public Function Execute(ByVal sSQL As String, ByRef dsDataSet As DataSet) As Boolean
