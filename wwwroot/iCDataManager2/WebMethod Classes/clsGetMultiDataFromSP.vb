...
Namespace iConsulting.iCMServer
    ...
    Public NotInheritable Class clsGetMultiDataFromSP : Inherits iConsulting.iCMServer.clsConnection

        Const CLASSNAME = "[Namespace::iConsulting.iCMServer][WebService::iCDataManager][Class::clsGetMultiDataFromSP]"
        ...
        Public Function Execute(ByVal dsMultiList As DataSet, ByRef dsDataSet As DataSet) As Boolean
            ...
            Try
                ...
                If TypeOf (oConn) Is SqlClient.SqlConnection Then
                    ...
                    For Each dr As DataRow In dsMultiList.Tables(0).Rows
                        oAdapter = New SqlClient.SqlDataAdapter(CType(dr("Query"), String), oConnection)
                        oCmdBuilder = New SqlClient.SqlCommandBuilder(oAdapter)
                        oAdapter.Fill(dsDataSet, CType(dr("Key"), String))
                    Next
                ...
                ElseIf TypeOf (oConn) Is CoreLab.MySql.MySqlConnection Then
                    ...
                    For Each dr As DataRow In dsMultiList.Tables(0).Rows
                        oAdapter = New CoreLab.MySql.MySqlDataAdapter(CType(dr("Query"), String), oConnection)
                ...
                ElseIf TypeOf (oConn) Is OleDb.OleDbConnection Then
                    ...
                    For Each dr As DataRow In dsMultiList.Tables(0).Rows
                        oAdapter = New OleDb.OleDbDataAdapter(CType(dr("Query"), String), oConnection)
